...
from hwio.dht11 import DHT11Sensor, DHT11MockSensor
from hwio.switch import SwitchOutputDevice

from logfile.csv_data_logger import CSVDataLogger
...
class Main:
    ...
    def __init__(self):
        ...
        self.dht11_sensor = DHT11MockSensor(  #DHT11Sensor(
            #gpio_pin    = 23,
            interval_sec = 2,
        ...
        self.csv_logger = CSVDataLogger(csv_filename)
    ...
    def dht11_read_cb(self, temperature, humidity):
        ...
        # Messwerte in der CSV-Datei fortschreiben
        self.csv_logger.log_values(
            temperature  = temperature,
            humidity     = humidity,
            light_switch = self.light_on,
        )
