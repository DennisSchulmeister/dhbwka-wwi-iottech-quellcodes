...
MESSAGE="This is the Hibiya Line. The next stop is Kasumigaseki. Change here for Marunouchi and Chiyoda Line."
...
if __name__ == "__main__":
    try:
        ...
        virtual = viewport(device, width=2000, height=100)
