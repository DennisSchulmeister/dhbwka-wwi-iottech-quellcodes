...
INTERNEN Pull-Up-Widerstand verbunden ist. Durch den Pull-Up wird der
GPIO-Eingangspin mit 3,3 V (deshalb Pull-UP) verbunden. Der Button
zieht den Pin dann auf Masse (Ground) runter, wenn er gedrückt wird.
Im Beispiel wird dazu GPIO 22 verwendet.
